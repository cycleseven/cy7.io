import Cy7Meta from "@cy7/website/common/components/Meta";
...
The `<Meta />` component should be rendered using the [Gatsby Head API](https://www.gatsbyjs.com/docs/reference/built-in-components/gatsby-head/).
...
function Head() {
  return <Meta title="My blog post" description="Description for search engines." />;
}
